...
execute_process(
  COMMAND "/usr/bin/git" show-ref "438a66e41807cd73e0c403966041b358f5eafc68"
  WORKING_DIRECTORY "/mnt/c/repos/RediSearch/_deps/cpu_features-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "438a66e41807cd73e0c403966041b358f5eafc68")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("438a66e41807cd73e0c403966041b358f5eafc68" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/438a66e41807cd73e0c403966041b358f5eafc68")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/c/repos/RediSearch/_deps/cpu_features-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/c/repos/RediSearch/_deps/cpu_features-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
