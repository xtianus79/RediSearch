...
void AGPLN_AddStep(AGGPlan *plan, PLN_BaseStep *step) {
  RS_LOG_ASSERT(NULL, step->type > PLN_T_INVALID, "Step type connot be PLN_T_INVALID", "");
...
void AGPLN_AddBefore(AGGPlan *pln, PLN_BaseStep *posstp, PLN_BaseStep *newstp) {
  RS_LOG_ASSERT(NULL, newstp->type > PLN_T_INVALID, "Step type connot be PLN_T_INVALID", "");
